<template>
  <div>
    <section class="bg-[#F7F7F7] dark:bg-gray-900">
        <div class="container flex flex-col gap-12 px-32 py-10 mt-14 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center">
