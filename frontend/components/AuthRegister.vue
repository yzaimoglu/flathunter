<template>
    <div>
        <section class="container mx-auto">
            <div class="flex justify-center w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-6xl">
                        ...
                        <form class="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <div class="flex items-center justify-between mt-4">
                                    ...
                                    <a @click="toggleLogin" class="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">or sign in</a>
...
<script setup>
    const states = useState('statesAuthentication')

    const toggleLogin = () => {
        states.value.login = !states.value.login
        states.value.register = !states.value.register
    }
</script>