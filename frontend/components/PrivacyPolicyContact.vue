    ...
    <div>
        <section class="bg-white dark:bg-gray-900">
            <div class="container px-6 py-12 mx-auto">
                <div>
                    <p class="font-medium text-blue-500 dark:text-blue-400">Further questions?</p>

                    <h1 class="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white">Feel free to contact us</h1>

                    <p class="mt-3 text-gray-500 dark:text-gray-400">We will make sure to answer your questions</p>
                </div>
