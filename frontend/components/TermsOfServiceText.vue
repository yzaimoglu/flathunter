        ...
        <section class="container px-6 py-12 mx-auto">
            <header class="container max-width-xs margin-bottom-lg">
                <div class="text-component text-center line-height-lg v-space-md margin-bottom-md">
                    <h1 class="mt-3 text-2xl font-semibold text-blue-500 dark:text-blue-400 md:text-3xl">Terms of Service</h1>
                </div>
            </header>
            <div class="container max-width-adaptive-sm mt-6">
                <div class="text-component line-height-lg v-space-md text-justify text-gray-900 dark:text-gray-300">
                    <p class="mb-4">
                    ...
                    <h3 class="mb-4 text-blue-500 dark:text-blue-400">
                    ...
                    <p class="mb-4">You warrant and represent that:</p>
                    <ul class="ml-6 mb-4 list-disc">
                        <li>
                    ...
                    <p class="mb-4">Approved organizations may hyperlink to our Website as follows:</p>
                    <ul class="ml-6 mb-4 list-disc">
                    ...
                    <p class="mb-8">Please read Privacy Policy</p>
                    <h3 class="mb-4 text-blue-500 dark:text-blue-400">
