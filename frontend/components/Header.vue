                ...
                <div class="lg:flex lg:items-center lg:justify-between">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex lg:hidden">
                            <button v-cloak @click="() => mobileMenu = !mobileMenu" type="button" class="text-gray-500 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400 focus:outline-none focus:text-gray-600 dark:focus:text-gray-400" aria-label="toggle menu">
                                <svg v-if="!mobileMenu" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <div v-cloak :class="[mobileMenu ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']" class="absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white dark:bg-gray-900 lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center">
                        <div class="flex flex-col -mx-6 lg:flex-row lg:items-center lg:mx-8">
                            <NuxtLink href="#" class="px-3 py-2 mx-3 mt-2 text-gray-700 transition-colors duration-300 transform rounded-md lg:mt-0 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Guide</NuxtLink>
                            <NuxtLink to="/dashboard" class="px-3 py-2 mx-3 mt-2 text-gray-700 transition-colors duration-300 transform rounded-md lg:mt-0 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Dashboard</NuxtLink>
                            <NuxtLink to="/contact" class="px-3 py-2 mx-3 mt-2 text-gray-700 transition-colors duration-300 transform rounded-md lg:mt-0 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Contact</NuxtLink>
                            <NuxtLink to="/faq" class="px-3 py-2 mx-3 mt-2 text-gray-700 transition-colors duration-300 transform rounded-md lg:mt-0 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">FAQ</NuxtLink>
                        </div>

                        <div class="flex items-center mt-4 lg:mt-0">
                            <button @click="toggleDarkMode" class="hidden mx-4 text-gray-600 transition-colors duration-300 transform lg:block dark:text-gray-200 hover:text-gray-700 dark:hover:text-gray-400 focus:text-gray-700 dark:focus:text-gray-400 focus:outline-none" aria-label="show notifications">
                                <svg v-if="darkModePreference" class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="800px" width="800px" version="1.1" id="Layer_1" viewBox="0 0 473.935 473.935" xml:space="preserve">
                                    <circle style="fill:#344E5D;" cx="236.967" cy="236.967" r="236.967"/>
                                    <radialGradient id="SVGID_1_" cx="13.4697" cy="528.3898" r="31.9283" gradientTransform="matrix(3.7418 0 0 -3.7418 186.5668 2214.0767)" gradientUnits="userSpaceOnUse">
                                ...
                                <svg v-if="!darkModePreference" class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="800px" width="800px" version="1.1" id="Layer_1" viewBox="0 0 473.931 473.931" xml:space="preserve">
                                    <circle style="fill:#F2BE3E;" cx="236.966" cy="236.966" r="236.966"/>
                                    <circle style="fill:#F1EB75;" cx="236.966" cy="236.966" r="117.154"/>
                                </svg>
                            </button>
                                <div @mouseenter="() => userMenu = true">
                                    ...
                                    >
                                        <div v-if="userMenu" @mouseleave="() => userMenu = false"  class="hidden min-[1024px]:block absolute right-0 top-0 z-20 w-48 py-2 mt-12 bg-white rounded-md shadow-xl dark:bg-gray-900">
...
<script setup>
    import { setLightMode, setDarkMode, getDarkMode } from '/utilities/darkMode'

    const mobileMenu = ref(false)
    const userMenu = ref(false)
    const darkModePreference = useState('darkModePreference')

    const toggleDarkMode = () => {
        darkModePreference.value = !darkModePreference.value
        if(darkModePreference.value) setDarkMode()
        else setLightMode()
    }
</script>
