        ...
        <section class="container px-6 py-12 mx-auto">
            <header class="container max-width-xs margin-bottom-lg">
                <div class="text-component text-center line-height-lg v-space-md margin-bottom-md">
                    <h1 class="mt-3 text-2xl font-semibold text-blue-500 dark:text-blue-400 md:text-3xl">Privacy Policy</h1>
                </div>
            </header>
            <div class="container max-width-adaptive-sm mt-6 text-gray-900 dark:text-gray-300">
                <div class="text-component line-height-lg v-space-md text-justify">
                    <p class="mb-4">
